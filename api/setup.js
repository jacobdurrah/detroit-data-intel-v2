const { handleCors, requireBearerAuth, sendJson, sendError } = require('./_helpers');
...
module.exports = async (req, res) => {
  ...
  var body = req.body || {};
  if (Object.prototype.hasOwnProperty.call(body, 'db_url')) {
    return sendError(res, 'db_url is not allowed; configure DATABASE_URL server-side', 400);
  }
