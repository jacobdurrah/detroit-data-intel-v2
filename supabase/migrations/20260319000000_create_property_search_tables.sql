...
-- Property Search Feature Tables
-- Run via Supabase Dashboard SQL Editor if not auto-applied
...
-- Public API readers may select data, but writes must go through authenticated
-- server-side API routes or service-role maintenance jobs.
DO $$ BEGIN
