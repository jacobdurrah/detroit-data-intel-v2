...
-- Enable RLS. Server-side APIs use the service key; anonymous clients may read
-- existing rows but cannot create or mutate pipeline data directly.
...
-- Replace any old anonymous read/write policy with read-only access.
DO $$ BEGIN
